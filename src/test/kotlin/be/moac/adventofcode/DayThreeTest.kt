...
internal class DayThreeTest {
    ...
    private val dayThree: DayThree = IntersectionCalculator()
    ...
    fun `that closest point to central point is calculated`(pathOne: String, pathTwo: String, expected: Int) {

        //When:
        val result = dayThree.calculateClosestIntersection(pathOne, pathTwo)
